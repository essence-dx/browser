...
import {
  ...
  repeat,
  styleMap,
} from "../../adapters/lit.mjs";
import { MozLitElement } from "../../adapters/lit.mjs";
import { ZenLibraryDragAndDrop } from "../ZenLibraryDragAndDrop.mjs";
import {
  isTab,
  getTabContainerSync,
  removeTab,
...
// Chromium: lit/directives + tab-strip + observer bus via adapters
// (npm lit / chrome.tabs / chrome.events on Chromium).
...
export class ZenLibrarySpacesSection extends MozLitElement {
  ...
  #onCopyDragEnd = event => {
    getTabContainerSync()?.tabDragAndDrop?.handle_dragend?.(event);
    this.#onDragEnd();
  };
  #landing = false;
  #sizingTimer = null;
  ...
  connectedCallback() {
    ...
    addObserver(this.#observer, GRADIENT_TOPIC);
  ...
  disconnectedCallback() {
    ...
    removeObserver(this.#observer, GRADIENT_TOPIC);
      ...
      >
        <div class="zen-library-space-header zen-squircle-before">
          ...
          >
            <img
              ...
              src="../../../browser/themes/shared/zen-icons/nucleo/paintbrush-fill.svg"
              alt=""
            />
          </toolbarbutton>
        </div>
        ...
        <div class="zen-library-space-footer">
          ...
          >
            <img
              class="toolbarbutton-icon"
              src="../../../browser/themes/shared/zen-icons/nucleo/drag-indicator.svg"
              draggable="false"
              alt=""
            />
          </toolbarbutton>
