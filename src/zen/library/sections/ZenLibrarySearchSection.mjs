...
import { html, when } from "../../adapters/lit.mjs";
      ...
      <div class="zen-library-search-top" ?open=${this.filtersOpen}>
        <div class="zen-library-search-header" ?inert=${this.filtersOpen}>
          <div class="zen-library-search-box">
            <img
              src="../../../browser/themes/shared/zen-icons/nucleo/search-glass.svg"
              alt=""
            />
            <input
              type="search"
          ...
          ${when(
            ...
            () => html`
              ...
              >
                <img src="../../../browser/themes/shared/zen-icons/nucleo/sliders.svg" alt="" />
